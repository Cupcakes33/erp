  ...
  const filteredWorks = works.filter(work => {
    ...
    const matchesSearch = filters.search 
      ? work.name?.toLowerCase().includes(filters.search.toLowerCase()) ||
        ...
        (work.instructionTitle && work.instructionTitle.toLowerCase().includes(filters.search.toLowerCase()))
      : true;
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800">작업 데이터 내보내기</h1>
      </div>
      ...
      <Card className="bg-white shadow-md rounded-lg p-6">
        <div className="mb-6">
          <h2 className="text-lg font-medium mb-4 text-gray-800">내보내기 설정</h2>
          ...
          <div className="mt-4">
            <p className="text-gray-600">
              현재 필터 설정으로 {filteredWorks.length}개의 작업이 내보내기됩니다.
            </p>
          </div>
        </div>

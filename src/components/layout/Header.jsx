        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <div className="relative ml-3">
              <button
                className="p-1 text-gray-600 rounded-full hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              ...
              {isNotificationOpen && (
                <div
                  className="absolute right-0 mt-2 origin-top-right bg-white rounded-md shadow-lg w-80 ring-1 ring-black ring-opacity-5 focus:outline-none"
                  role="menu"
                ...
                >
                  ...
                  >
                    ...
                    <div className="overflow-y-auto max-h-60">
                      <div className="px-4 py-3 border-b border-gray-100 hover:bg-gray-100">
                        <p className="text-sm font-medium text-gray-800">
                          새로운 지시가 등록되었습니다.
                        </p>
                        <p className="mt-1 text-xs text-gray-500">방금 전</p>
                      </div>
                      <div className="px-4 py-3 border-b border-gray-100 hover:bg-gray-100">
                        <p className="text-sm font-medium text-gray-800">
                          작업 상태가 변경되었습니다.
                        </p>
                        <p className="mt-1 text-xs text-gray-500">1시간 전</p>
                      </div>
